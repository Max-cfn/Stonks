...
_BUILTIN_PATTERNS: list[tuple[str, str, CategoryGroup, str, str, str]] = [
    ...
    (
        "description",
        r"\b(salaire|salaire\s*net|traitement|paie\s|salary|wage|payroll)\b",
    ...
    (
        "description",
        r"\b(freelance|honoraires|prestation|mission|consulting)\b",
        CategoryGroup.INCOME,
        "Freelance",
        "💻",
        "#2E7D32",
    ...
    (
        "description",
        r"\b(remboursement|reimbursement|refund|remb\.?|avoir)\b",
        CategoryGroup.INCOME,
        "Remboursements",
        "↩️",
        "#2E7D32",
    ...
    (
        "description",
        r"\b(CAF|alloc|APL|aides?|bourse|scholarship|grant)\b",
        CategoryGroup.INCOME,
        "Aides",
        "🤝",
        "#2E7D32",
    ...
    (
        "description",
        r"\b(loyer|rent|charges?\s*copro|propri[ée]taire|landlord)\b",
    ...
    (
        "description",
        r"\b([ée]lectricit[ée]|EDF|engie|total\s+energ|electricity|power)\b",
        CategoryGroup.HOUSING,
        "Électricité",
        "⚡",
        "#E65100",
    ...
    (
        "description",
        r"\b(eau|water|veolia|suez|saur)\b",
        CategoryGroup.HOUSING,
        "Eau",
        "💧",
        "#E65100",
    ...
    (
        "description",
        r"\b(internet|fibre|box|orange|free|bouygues|sfr|broadband)\b",
        CategoryGroup.HOUSING,
        "Internet",
        "🌐",
        "#E65100",
    ...
    (
        "description",
        r"\b(assurance\s*hab|home\s*insur|MAIF|MMA|axa\b|matmut|maaf|allianz)\b",
        CategoryGroup.HOUSING,
    ...
    (
        "description",
        r"\b(courses?|supermarch[ée]|carrefour|leclerc|auchan|intermarch[ée]|"
    ...
    (
        "description",
        r"\b(restaurant|resto|pizzeria|sushi|burger|kebab|mc\s*do|"
    ...
    (
        "description",
        r"\b(caf[ée]|starbucks|coffee|columbus|nespresso)\b",
        CategoryGroup.FOOD,
        "Café",
        "☕",
        "#4CAF50",
    ...
    (
        "description",
        r"\b(uber\s*eats|deliveroo|just\s*eat|livraison|delivery|takeaway)\b",
        CategoryGroup.FOOD,
        "Livraison",
        "🛵",
        "#4CAF50",
    ...
    (
        "description",
        r"\b(essence|gasoil|diesel|gazole|sp98|sp95|e10|fuel|gas\s*station|"
    ...
    (
        "description",
        r"\b(transport|m[ée]tro|bus|tram|ratp|sncf|t[ée]l[ée]p[ée]age|"
    ...
    (
        "description",
        r"\b(parking|stationnement|horodateur|indigo|effia)\b",
        CategoryGroup.TRANSPORT,
        "Parking",
        "🅿️",
        "#1976D2",
    ...
    (
        "description",
        r"\b(pharmaci[ea]|m[ée]dicament|ordo|pharmacy|drugstore)\b",
    ...
    (
        "description",
        r"\b(m[ée]decin|docteur|consultation|medical|g[ée]n[ée]raliste|"
    ...
    (
        "description",
        r"\b(mutuelle|compl[ée]mentaire\s*sant[ée]|health\s*insur)\b",
        CategoryGroup.HEALTH,
        "Mutuelle",
        "🏥",
        "#D32F2F",
    ...
    (
        "description",
        r"\b(v[êe]tement|habit|zara|h&m|uniqlo|decathlon|kiabi|primark|"
    ...
    (
        "description",
        r"\b([ée]lectronique|fnac|darty|boulanger|amazon|cdiscount|"
    ...
    (
        "description",
        r"\b(maison|d[ée]co|ikea|leroy\s*merlin|castorama|maison\s*du\s*monde|"
    ...
    (
        "description",
        r"\b(sport|gym|fitness|basic.fit|keepcool|salle\s*sport)\b",
    ...
    (
        "description",
        r"\b(abonnement|subscription|netflix|spotify|deezer|disney\+|"
    ...
    (
        "description",
        r"\b(cin[ée]ma|th[ée][âa]tre|concert|spectacle|festival|mus[ée]e|"
    ...
    (
        "description",
        r"\b(voyage|billet\s*avion|airbnb|booking|hotel|train|vol|"
    ...
    (
        "description",
        r"\b(frais\s*banc|commission|cotisation\s*cb|bank\s*fee|frais\s*tenu[eé])\b",
    ...
    (
        "description",
        r"\b(imp[ôo]t|taxe|dgfip|fisc|urssaf|tva|vat|income\s*tax)\b",
        CategoryGroup.FINANCIAL,
        "Impôts",
        "📝",
        "#607D8B",
    ...
    (
        "description",
        r"\b(cr[ée]dit|pr[êe]t|emprunt|[ée]ch[ée]ance|mensualit[ée]|loan)\b",
        CategoryGroup.FINANCIAL,
        "Crédit",
        "💳",
        "#607D8B",
    ...
    (
        "creditor_name",
        r"(La\s*Poste|Colissimo|Chronopost)",
        CategoryGroup.SHOPPING,
        "Maison",
        "🪴",
        "#9C27B0",
